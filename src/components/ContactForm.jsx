...
const ContactForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const serviceId = 'service_mw5315w'; // Update with your service ID
    const templateId = 'template_nl4lbrp'; // Update with your template ID
    const userId = '_ExKRX2CgZMwjSlBp'; // Update with your user ID (public key)
